...
weight: 3
aliases:
  - /learning-paths/1e2a8e46-937c-47ea-ab43-5716e3bcab2e/end-to-end-kubernetes/kubernetes-workshop/workshop/local/
---
...
We use Multipass as it is handy and lightweight, but feel free to use the tool you're the most comfortable with. If you use another tool, please just make sure to adapt the commands below. For example, people reported having used [Minikube](https://minikube.sigs.k8s.io/docs/) successfully instead of Multipass & k3s.
{{< /hextra/callout >}}
