...
![Pulumi stack](./images/stack-created.png)
...
Next, we deploy the stack, which creates the infrastructure components defined in Pulumi.yaml, applying the configuration from Pulumi.demo.yaml.
...
![Portal](./images/cluster-created.png)
