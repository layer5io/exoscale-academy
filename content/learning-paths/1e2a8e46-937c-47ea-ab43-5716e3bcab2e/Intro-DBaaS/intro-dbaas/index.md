...
![](data_word_cloud.png "Data Word Cloud")
...
![](CHM.png "Computer History Museum - Databases")
...
If you want to know the entire history with more details, you can watch it (History of Databases by Computer History Museum) on YouTube in less than six minutes <a href="https://www.youtube.com/watch?v=KG-mqHoXOXY" target="_blank">__here__</a>. A quick structured overview of the History of the Database Evolution is put together in the next unit.
...
If you want to have a QuickStart with these technologies, go to our DBaaS Documentation <a href="https://community.exoscale.com/documentation/dbaas/quick-start/" target="_blank">__here__</a>.
...
If you want to know more about the actual service offers, please go to <a href="https://www.exoscale.com/dbaas/" target="_blank">__Exoscale DBaaS__</a> on our website.
...
* Both companies are __GDPR-compliant__ to ensure the highest standards for customers’ data. The sole use of __Open Source__ projects ensures that customers are not vendor locked-in and always at the latest technology standard.
